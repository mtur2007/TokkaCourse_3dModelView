...
function GenerateDefinitionCode(uiTree){
    ...
    let html_code = '<div id="UiGroup" style="position: fixed; top: 140px; left: 20px; z-index: 100;">\n'
    let js_def_code = ''
    let js_code = 'export function UIevent (uiID, toggle){\n'
...
const UI_idx = getAllkeys(rename_uiTree)[0]

console.log(getAllkeys(rename_uiTree)[0])
console.log(uiTree)
